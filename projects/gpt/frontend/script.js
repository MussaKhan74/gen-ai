...
async function genrerate(text) {
    /**
     * 1. append message in ui
     * 2. send it to LLM
     * 3. append response to the ui
     */

    // Adding user message to chat container
    ...
    // Adding loading message to chat container
    ...
    // Adding assistant message to the chat container
    ...
    // Remove loading message from chat container
    loading.remove();
